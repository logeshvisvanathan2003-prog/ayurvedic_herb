...
-- ================================
-- STEP 8: Conservation zones (geo-fencing + seasonal + quota smart-contract-style rules)
-- ================================
...
-- ================================
-- STEP 9: Chain-of-custody transfers (anti-transport-fraud QR handoffs)
-- ================================
